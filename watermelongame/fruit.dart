...
class Fruit extends PositionComponent with HasGameRef, CollisionCallbacks {
  Vector2 velocity = Vector2.zero();

  late final Vector2 initialPosition;

  Fruit({required bool isMe}) : _isMyPlayer = isMe;
  ...
  void onCollision(Set<Vector2> intersectionPoints, PositionComponent other) {
    ...
    print('some');
    // if (other is Fruit && _isMyPlayer != other.isMine) {
