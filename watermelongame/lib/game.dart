...
class MyGame extends FlameGame with PanDetector, HasCollisionDetection {
  ...
  /// `Fruit` instance of the player
  late Fruit _player;

  /// `Fruit` instance of the opponent
  late Fruit _opponent;
